...
colidedSound = loadSound("collided.wav");
...
function setup() {
  ...
  girl = createSprite(50,height-800,1,2);
...
sun.scale =0.2;
  ...
  iground = createSprite(0,height-170,width*2,10);
  iground.visible = false;
  
ground = createSprite(0,height-100,width*5,30)
ground.x = width/2;
...
function draw() {
  ...
  if (gameState===PLAY){
   ...
   if(obstaclesGroup.isTouching(girl)){
    ...
    if(girl.isTouching(obstaclesGroup)&& life>0){
      life=life-1
    }
